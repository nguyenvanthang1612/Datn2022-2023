...
namespace Magenest\RegionStock\Plugin\Magento\ConfigurableProduct\Model\Plugin\Frontend;
...
{
    public function beforeAroundGetUsedProducts(
        \Magento\ConfigurableProduct\Model\Plugin\Frontend\UsedProductsCache $cache,
