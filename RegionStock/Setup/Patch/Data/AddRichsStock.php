...
namespace Magenest\RegionStock\Setup\Patch\Data;
 ...
 */
class AddRichsStock implements DataPatchInterface
{
    const RICHS_STOCK_NAME = 'Richs Stock';
    ...
    public function addStock()
    {
        ...
        $stockData = [
            StockInterface::NAME => self::RICHS_STOCK_NAME
        ];
